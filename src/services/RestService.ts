...
export namespace RestService {
  ...
  export const products: Model.Product[] = [
    {
      uid: "1",
      ...
      category: { name: "men's clothing", uid: "7-azeeert" },
    ...
    },
    {
      ...
      category: { name: "jewelery", uid: "6-azeeert" },
      imageUrl:
    ...
    },
    {
      ...
      quantity: 64,
      description:
        "USB 3.0 and USB 2.0 Compatibility Fast data transfers Improve PC Performance High Capacity; Compatibility Formatted NTFS for Windows 10, Windows 8.1, Windows 7; Reformatting may be required for other ope//   rating systems; Compatibility may vary depending on user’s hardware configuration and ope//   rating system",
      category: { name: "electronics", uid: "8-azeeert" },
    ...
    },
    {
      ...
      category: { name: "women's clothing", uid: "4-azeeert" },
